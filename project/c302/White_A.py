# =============================================================================
# 功能描述：
#   WhiteDataReader.White_A 读取器的临时适配器模块。
#   将 White_A 类的 read_data/read_muscle_data 方法暴露为模块级别名，
#   以供比较 notebook 使用。数据源：White et al. 1986 成虫连接组（adult）。
#
# 类与方法索引：
#   main1                                (L29)   — 读取 White_A 连接组数据并打印统计摘要
#
# 更新日志：
...
# 后续应整理为更规范的形式。
# 数据源：White et al. 1986 成虫神经元连接组（adult）
