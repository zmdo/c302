...
#
# 类与方法索引：
#   get_cell_id_string                   (L36)   — 构建 NeuroML 中引用细胞实例的路径字符串
#   is_cond_based_cell                   (L65)   — 判断参数层级是否为导电模型（Level C 或 D 系列）
#   create_neuron_populations            (L74)   — 在网络中创建神经元种群
#   create_muscle_populations            (L228)  — 在网络中创建肌肉种群
#
# 更新日志：
